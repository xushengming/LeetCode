public class _211AddAndSearchWord_DataStructureDesign {
    ...
    public static void main(String[] args) {
        _211AddAndSearchWord_DataStructureDesign addAndSearchWord_dataStructureDesign = new _211AddAndSearchWord_DataStructureDesign();
        WordDictionary wordDictionary = addAndSearchWord_dataStructureDesign.new WordDictionary();
        wordDictionary.addWord("bad");
        wordDictionary.addWord("dad");
        wordDictionary.addWord("mad");
        System.out.println("wordDictionary = " + wordDictionary.search("pad"));
        System.out.println("wordDictionary = " + wordDictionary.search("bad"));
        System.out.println("wordDictionary = " + wordDictionary.search(".ad"));
        System.out.println("wordDictionary = " + wordDictionary.search("b.."));
    }
}
